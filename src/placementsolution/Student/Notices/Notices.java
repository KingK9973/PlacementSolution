package placementsolution.Student.Notices;
...
public class Notices extends javax.swing.JFrame {
    ...
    private void populateTable() {
        ...
        try {
            ...
            c.r_set = c.stm.executeQuery("SELECT n.\"DATE\", n.SUBJECT, n.MESSAGE FROM SA.NOTICES n "
                    + "WHERE n.STATUS = 'V'");
            while (c.r_set.next()) {
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        JOptionPane.showMessageDialog(null, "Subject : " + jTable.getValueAt(jTable.getSelectedRow(), 1)
