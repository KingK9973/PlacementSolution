package placementsolution.Student.Interview;
...
public class ViewInterview extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1000, 553));
        setPreferredSize(new java.awt.Dimension(1000, 553));
    ...
    void populateTable() {
        ...
        try {
            ...
            Logger.getLogger(ViewInterview.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void setLook() {
        try {
            ...
            java.util.logging.Logger.getLogger(ViewInterview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
