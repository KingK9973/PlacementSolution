...
public class ListNotice extends javax.swing.JPanel {
...
void populateTable() {
        ...
        try {
            ...
            Logger.getLogger(ListNotice.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void setLook() {
        try {
            ...
            java.util.logging.Logger.getLogger(ListNotice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
