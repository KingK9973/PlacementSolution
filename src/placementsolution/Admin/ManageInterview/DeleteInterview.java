...
public class DeleteInterview extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Interview");
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Company", "Date", "Venue", "Skills", "Stream", "Sem.", "Package", "Discription", "Status"
            }
        ) {
        ...
        try {
            ...
            while (c.r_set.next()) {
                ...
                model.addRow(new Object[]{c.r_set.getString(1), c.r_set.getString(2), c.r_set.getString(3),
                    ...
                    c.r_set.getString(8), c.r_set.getString(9), false});
            }
            c.sql_con.close();
        } catch (SQLException ex) {
            Logger.getLogger(DeleteInterview.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void PaneDeleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PaneDeleteBtnMouseClicked
        ...
        for (int i = 0; i < jTable.getRowCount(); i++) {
            if (jTable.getValueAt(i, 9).equals(true)) {
                try {
                    c.pre_s = c.sql_con.prepareStatement("update INTERVIEW set STATUS = ? where IID = ?");
                    c.pre_s.setString(1, "I");
                    c.pre_s.setString(2, jTable.getValueAt(i, 0).toString());
    ...
    private void setLook() {
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteInterview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
